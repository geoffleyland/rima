...
function test(options)
  ...
  do 
    ...
    T:check_equal(sum.build{y=Q}(sets.ord(y)), "sum{y in Q}(ord(y))")
    T:check_equal(E(sum.build{y=Q}(sets.ord(y)), S), 6)
  ...
  do
    ...
    T:check_equal(sum.build{R=sets.range(2, r)}(R), "sum{R in range(2, r)}(R)")
    T:check_equal(sum.build{R=sets.range(2, 10)}(R), "sum{R in range(2, 10)}(R)")
    T:check_equal(E(sum.build{R=R}(R), S), "sum{R in range(2, r)}(R)")
    T:check_equal(E(sum.build{y=R}(y), S), "sum{y in range(2, r)}(y)")
    T:check_equal(E(sum.build{y=sets.range(2, r)}(y), S), "sum{y in range(2, r)}(y)")
    T:check_equal(E(sum.build{y=sets.range(2, 10)}(y), S), 54)
    S.r = 10
    T:check_equal(E(sum.build{R=R}(R), S), 54)
    T:check_equal(E(sum.build{y=R}(y), S), 54)
    T:check_equal(E(sum.build{y=sets.range(2, r)}(y), S), 54)
  end
