...
function test(show_passes)
  ...
  T:expect_error(function() S3.a = types.undefined_t:new() end, "cannot set 'a' to 'a undefined': violates existing constraint")
  ...
  T:expect_error(function() S3.a = rima.integer(1, 10) end, "cannot set 'a' to '1 <= a <= 10, a integer': existing definition")
