...
--  T:expect_ok(function() add:check({{1, 2}}) end) 
  ...
  U{ "2 + b + 3", S="2 + b + 3", D="+(1*+(1*2, 1*ref(b)), 1*3)", ES="5 + b" }
  U{ "2 - (3 + b)", S="2 - (3 + b)", D="+(1*2, -1*+(1*3, 1*ref(b)))", ES="-1 - b" }

  U{ "2 + a + 3", S="2 + a + 3", D="+(1*+(1*2, 1*ref(a)), 1*3)", ES=10 }
  U{ "2 - (3 + a)", S="2 - (3 + a)", D="+(1*2, -1*+(1*3, 1*ref(a)))", ES=-6 }
  U{ "-a", S="-a", D="+(-1*ref(a))", ES=-5 }

  -- Tests with mul
  U{ "2 + 3*b", S="2 + 3*b", D="+(1*2, 1**(3^1, ref(b)^1))", ED="+(1*2, 3*ref(b))" }
  U{ "2 + b*c", S="2 + b*c", D="+(1*2, 1**(ref(b)^1, ref(c)^1))", ED="+(1*2, 1**(ref(b)^1, ref(c)^1))" }
  U{ "2 + 5*b*c", S="2 + 5*b*c", D="+(1*2, 1**(*(5^1, ref(b)^1)^1, ref(c)^1))", ED="+(1*2, 5**(ref(b)^1, ref(c)^1))" }
