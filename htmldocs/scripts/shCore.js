...
sh.Highlighter.prototype = {
	...
	highlight: function(code, params)
	{
		...
		// process light and inline mode
		if (this.getParam('light') == true || this.getParam('inline') == true)
			this.params.toolbar = this.params.gutter = false;

		if (this.getParam('inline') == true)
		{
			this.div = div = this.create('SPAN');
			this.lines = this.create('SPAN');
		}
		else
		{
